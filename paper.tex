...
% https://www.dropbox.com/scl/fo/mvds2vmlka4j33v69ip6r/h?dl=0&rlkey=osfeagghu2lh4qkr5ig9w0v47
% https://www.dropbox.com/scl/fo/on0xgqzaeds3ys9b2sxxy/h?dl=0&rlkey=xvgm1v2arob7lzi7lvggmea81
%
%----------------------------------------------------------------------------------------
...
\begin{figure}[!h]
  ...
  \vspace{-3mm} 
  \begin{center}
    \includegraphics[width=0.55\textwidth, trim={0 0 0 0},clip]{author_files/14-bis.jpeg}
  \end{center}
  {\footnotesize
...
\begin{figure}[!h]
  ...
  \begin{center}
    ...
    \begin{minipage}[t]{\x\linewidth}
      \includegraphics[width = \textwidth, trim={0 0.8cm 0 0.9cm},clip]{author_files/nimbodetector.png}	
      \captionsetup{justification=centering, font=footnotesize}
      \caption*{(a)}\label{fig:triangle2a}
    \end{minipage}
    \begin{minipage}[t]{\x\linewidth}
      \includegraphics[width = \textwidth, trim={0 0.8cm 0 0.9cm},clip]{author_files/sensor.png}	
      \captionsetup{justification=centering, font=footnotesize}
...
\begin{figure}[!h]
  ...
  \vspace{-3mm} 
  \begin{center}
    \includegraphics[width=0.85\textwidth, trim={0 0 0 0},clip]{author_files/graph.png}
  \end{center}
