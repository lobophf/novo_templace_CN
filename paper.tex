...
\newcommand{\cncoverheader}{
  \noindent\begin{tikzpicture}[remember picture, overlay]
    \begin{scope}[shift={(0,-10mm)}]
      ...
      \node[left, anchor=east, inner sep = 0mm] at (\textwidth, 1.5mm) {\includegraphics[height=4.5mm]{images/acesso-aberto.png}};
      ...
      \node[anchor=north, inner sep=2mm, yshift=-4mm] at (\textwidth / 2, 0) {\footnotesize Submissão: \submitionDate~\custombullet~Aprovação: \approvalDate~\custombullet~Publicação: \publishDate};
